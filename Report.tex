...
Dữ liệu sử dụng trong dự án là bộ dữ liệu \textbf{Boston Housing} — một bộ dữ liệu kinh điển cho bài toán dự đoán giá nhà. Dữ liệu có thể lấy từ các nguồn công khai như UCI hoặc Kaggle (ví dụ: \url{https://www.cs.toronto.edu/~delve/data/boston/bostonDetail.html}). Bộ dữ liệu gồm \textbf{506 mẫu} với \textbf{13 đặc trưng} đầu vào và một biến mục tiêu \texttt{MEDV} (giá trị trung bình của nhà, đơn vị: \$1000).
